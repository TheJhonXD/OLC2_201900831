...
const save_file = document.querySelector('#save-file');
const open_file = document.querySelector('#open-file');
const input_file_read = document.querySelector('#fileread');
...
/* Abrir archivo */
open_file.addEventListener('click', (e) => {
    input_file_read.click();
});

input_file_read.addEventListener('change', (e) => {
    leerArchivo(e);
});

/* Guardar como */
save_as.addEventListener('click', (e) => {
    let name = prompt("Ingrese el nombre del archivo");
    if (name) {
        guardarArchivo(name);
    }
});
...
/* Guardar */
save_file.addEventListener('click', (e) => {
