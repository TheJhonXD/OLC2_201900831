...
: VAR ID COLON tipo IG expr {$var = instructions.NewVar($VAR.line, $VAR.pos, $expr.e)}
| VAR ID IG expr            {$var = instructions.NewVar($VAR.line, $VAR.pos, $expr.e)}
| VAR ID COLON tipo Q_MARK  {$var = instructions.NewVar($VAR.line, $VAR.pos, "nil")} //!Error al retornar nada aquí
;
